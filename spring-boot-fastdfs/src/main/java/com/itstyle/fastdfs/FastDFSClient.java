...
public class FastDFSClient{
    ...
    public static void main(String[] args) throws Exception {
        ...
        String fileId = "M00/00/00/i7TCvl14lbyAUqEIAAuy9TZQ7M0343.gif";
        File newFile = new File("D:/new_11582.gif");
    	FastDFSClient client = new FastDFSClient();
//    	File file = new File("D:/11582.gif");
//        String[] result = client.uploadFile(file, "gif");
//        System.out.println(result.length);
//        System.out.println(result[0]);
//        System.out.println(result[1]);

        int a = client.downloadFile(groupName, fileId, newFile);
